...
headquartersApp.use(express.static(path.join(__dirname, "shooting-range")))
...
headquartersApp.listen(PORT.HEADQUARTERS, () =>
  console.log(`http://localhost:${PORT.HEADQUARTERS}`)
)
